...
public class Moneyatre {
 static Map<String,Accounts> AccountsList = new HashMap<String,Accounts>(){{put("1047",new Accounts("Shaheryar Raza",2244,10.0,"4220173521679"));put("1048",new Accounts("John",2348,0.0,"4220173521678"));}};
